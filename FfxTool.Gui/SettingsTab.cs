...
namespace FfxTool.Gui
{
    ...
    public class SettingsTab : UserControl
    {
        ...
        {
            var card = new Md3Card { Variant = Md3CardVariant.Elevated, Width = Md3Tokens.ContentMaxWidth, AutoSize = true, Padding = new Padding(Md3Tokens.Space6), Margin = new Padding(0, 0, 0, Md3Tokens.Space4) };
        ...
        {
            var card = new Md3Card { Variant = Md3CardVariant.Elevated, Width = Md3Tokens.ContentMaxWidth, AutoSize = true, Padding = new Padding(Md3Tokens.Space6) };
            var flow = new FlowLayoutPanel { FlowDirection = FlowDirection.TopDown, AutoSize = true, WrapContents = false };
